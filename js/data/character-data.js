...
export const CHARACTER_DATA = {
  paladin: {
    ...
    className: 'Paladin',
    icon: '🛡️',
    portrait: 'placeholder/paladin.svg',
  ...
  rogue: {
    ...
    className: 'Rogue',
    icon: '🗡️',
    portrait: 'placeholder/rogue.svg',
  ...
  berserker: {
    ...
    className: 'Berserker',
    icon: '🪓',
    portrait: 'placeholder/berserker.svg',
    tagline: 'Blood Rage',
  ...
  cleric: {
    ...
    className: 'Cleric',
    icon: '✨',
    portrait: 'placeholder/cleric.svg',
  ...
  scout: {
    ...
    className: 'Scout',
    icon: '🏹',
    portrait: 'placeholder/scout.svg',
    tagline: "Keen Eyes",
